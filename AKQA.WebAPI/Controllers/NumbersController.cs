...
using AKQA.WebAPI.Models;

namespace AKQA.WebAPI.Controllers
{
    [EnableCors("http://localhost:54078", "*", "*")]
    public class NumbersController : ApiController
    {
        // GET: api/v1/numbers/{parameterNumber}/numberinwords
        public RenderedNumber Get(int number)
        {
            var renderedNumber = new RenderedNumber { ValueInEnglish = Converter.ConvertNumberToString(number) };
    ...
    {
        //Converts any number between 0 and the maximum value of an int: 2,147,483,647
        ...
        //Converts number between 10 and 19
        ...
        //Converts number between 20 and 99
        ...
        //Converts any number bigger than 99
